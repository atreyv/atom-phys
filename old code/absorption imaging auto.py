...
#dname = 'D:/Data/2014/June/MOT/13_06_14/abs_test1/'
...
#
#
def load_and_average(dname,raw_image,cycles):
...
#        pattern2 = files[i][len(prefix):len(prefix)+number_of_digits_for_files]
        ...
        for j in range(0,cycles*3,3):
            ...
            # Sum and average
            res += normalize_by_division((signal-backg), (ref-backg)) / cycles
...
#        plt.colorbar()
    ...
    print "b0 = ", b0
    sigma_z = np.abs(p[3])*pixel_size
    sigma_x = np.abs(p[4])*pixel_size
